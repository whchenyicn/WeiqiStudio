...
const defaultTopics: LearningTopic[] = [
  ...
  },
  {
    ...
    href: '/articles/weiqi-board-and-stones',
    icon: 'lessons',
    label: 'Beginner path',
  },
  {
    ...
    href: '/articles/weiqi-terms-glossary',
    icon: 'glossary',
    label: 'Reference',
  },
  {
    ...
    href: '/articles/how-to-improve-at-weiqi',
    icon: 'strategy',
  ...
  },
  {
    ...
    href: '/articles/beginner-weiqi-mistakes',
    icon: 'mistakes',
